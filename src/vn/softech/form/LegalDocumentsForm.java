...
public class LegalDocumentsForm extends TblLegalDocuments {
    ...
    private List<TblLegalDocuments> listLegalDocuments = new ArrayList<TblLegalDocuments>();
	...
	public List<TblLegalDocuments> getListLegalDocuments() {
		return listLegalDocuments;
	}
	public void setListLegalDocuments(List<TblLegalDocuments> listLegalDocuments) {
		this.listLegalDocuments = listLegalDocuments;
	}
