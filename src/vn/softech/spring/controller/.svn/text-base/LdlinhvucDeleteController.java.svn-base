...
@Controller
public class LdlinhvucDeleteController {
	LdLinhVucDao ldlinhvucdao= new LdLinhVucDao();
	private static Logger log = Logger.getLogger(LdlinhvucDeleteController.class);

	@RequestMapping (value = "/admin/ldlinhvuc/delete")
