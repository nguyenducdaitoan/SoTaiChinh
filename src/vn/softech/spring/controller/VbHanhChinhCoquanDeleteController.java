...
@Controller
public class VbHanhChinhCoquanDeleteController {
	LdCoQuanDao ldcoquandao= new LdCoQuanDao();
	private static Logger log = Logger.getLogger(VbHanhChinhCoquanDeleteController.class);
	
	@RequestMapping (value = "/admin/vbhanhchinhcoquan/deleteajaxldcoquan")
