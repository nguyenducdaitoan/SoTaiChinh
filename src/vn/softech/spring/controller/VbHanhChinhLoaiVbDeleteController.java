...
@Controller
public class VbHanhChinhLoaiVbDeleteController {
	LdLoaiVbDao ldloaivbdao= new LdLoaiVbDao();
	private static Logger log = Logger.getLogger(VbHanhChinhLoaiVbDeleteController.class);

	@RequestMapping (value = "/admin/vbhanhchinhloaivb/delete")
