...
<title>Thêm mới lĩnh vực văn bản</title>
...
<body>
	<form:form commandName="ldlinhvuc" name="LdLinhVucForm" id="formldLinhVucId" method="POST" action="/admin/vbhanhchinhlinhvuc/submitadd.html" accept-charset="UTF-8">
	<input type="hidden" name="type" value="1">
	<div id="bodyadmin">
	    <div id="header">
	        <div style="width: 250px; text-align:left; float:left; font-family: Tahoma; font-size:10pt;">
	            <img src="/admin/images/data.gif" title="" />&nbsp;Thêm mới lĩnh vực văn bản
	        </div>
