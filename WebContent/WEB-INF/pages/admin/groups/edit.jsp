	...
	$(document).ready(function() {
		$("img#imgSaveNews").click(function(){
			if ($("input[name='name']").val() == '') {
				alert('Bạn chưa nhập tên nhóm quyền!');
...
<body>
	<form:form name="GroupsForm" commandName="groupsForm" method="POST" action="/admin/groups/edit.html">
	<form:hidden path="groupsId"/>
	<div id="bodyadmin">
	    <div id="header">
	        <div style="width: 250px; text-align:left; float:left; font-family: Tahoma; font-size:10pt;">
	            <img src="images/data.gif" title="" />&nbsp;Sửa thông tin vai trò người dùng
	        </div>
