...
<body>
	<form:form commandName="ldcoquan" name="LdCoQuanForm" id="ldCoQuanFormId" method="POST" action="/admin/vbhanhchinhcoquan/submitedit.html" accept-charset="UTF-8">
	<form:hidden path="ldCoQuanId"/>
	<div id="bodyadmin">
	    <div id="header">
	        <div style="width: 250px; text-align:left; float:left; font-family: Tahoma; font-size:10pt;">
	            <img src="/admin/images/data.gif" title="" />&nbsp;Chỉnh sửa cơ quan
	        </div>
