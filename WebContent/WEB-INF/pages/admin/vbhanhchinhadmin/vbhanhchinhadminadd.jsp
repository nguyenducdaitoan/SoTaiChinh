...
<body>
	<form:form commandName="vbhanhchinh" name="LegalDocumentsForm" id="formLegalDocumentsId" method="POST" action="/admin/vbhanhchinhadmin/submitadd.html" accept-charset="UTF-8" enctype="multipart/form-data">
	<div id="bodyadmin">
	    <div id="header">
	        <div style="width: 250px; text-align:left; float:left; font-family: Tahoma; font-size:10pt;">
	            <img src="/admin/images/data.gif" title="" />&nbsp;Thêm mới văn bản
	        </div>
