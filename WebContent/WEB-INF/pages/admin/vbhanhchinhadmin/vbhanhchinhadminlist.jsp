			...
			if (list_activities_id == "") {
				...
				if (ok) {
					$.ajax({
						cache: false,
						type: 'POST',
						url:   '/admin/vbhanhchinhadmin/deleteajaxlegaldocuments.html',
						data:  'documentsId=' + list_activities_id,
						dataType: "html",
						success: function(data) {
							...
							if ((getData.error != null) && (getData.error != '')) {
								...
								window.location.href = '/admin/vbhanhchinhadmin/list.html';
							}
						},
		...
		$(".deleteIterm").click(function() {
			...
			if (ok)	{
				...
				$.ajax({
					...
					type: 'POST',
					url:   '/admin/vbhanhchinhadmin/deleteajaxlegaldocuments.html',
					data:  'documentsId=' + legalDocumentsId,
					dataType: "html",
					success: function(data) {
						var getData = $.parseJSON(data);
						if ((getData.error != null) && (getData.error != '')) {
...
<body>
	<div id="bodyadmin">
	<form:form commandName="vbhanhchinhform" method="Post">
    	<div id="header">
            ...
            <div style="width: 130px; text-align:right; float:right;">
            	<div style="position:absolute; top:1px;">
	                <a href="/admin/vbhanhchinhadmin/add.html" title="News"><img id="btnadd" src="/admin/images/add.gif" style="border: none" title="New" /></a>&nbsp;
 ...
 -->
        ...
        <center>
        	<table id="tableOne" class="tablesorter" cellspacing="1" style="width:100%; padding-top: 0px; margin-top: 0px">
                ...
                <c:forEach var="doc" items="${listvbhanhchinh}" varStatus="status">
					<tr>				
                        ...
                        <td>
                            <span class="selectAllItems"><input id="checkbox-id-<c:out value="${doc.getVbHanhChinhId()}"/>" type="checkbox" name="chkdelete" title="Chọn" /></span>
                            <span class="deleteItems"><img src="/admin/images/delete.gif" class="deleteIterm" id="delete-id-<c:out value="${doc.getVbHanhChinhId()}"/>" title="Xóa" /></span>
                            <span class="editItems"><a href="/admin/vbhanhchinhadmin/edit.html?vbHanhChinhId=<c:out value="${doc.getVbHanhChinhId()}"/>"><img src="/admin/images/lightning_go.gif" title="Sửa" class="editIterm" style="border: none" /></a></span>
						</td>
                    </tr>
              	</c:forEach>
	    ...
	    <div id="footer">
			...
			<div style="float:right; width:230px;">Tổng số:&nbsp;<c:out value="${vbhanhchinhform.getTotalRecord()}"/> &nbsp;/&nbsp;<c:out value="${vbhanhchinhform.getTotalPage()}"/>&nbsp;Trang
