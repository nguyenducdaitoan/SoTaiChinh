...
<body>
	<form:form commandName="vbhanhchinh" name="LegalDocumentsForm" id="formLegalDocumentsId" method="POST" action="/admin/vbhanhchinhadmin/submitedit.html" accept-charset="UTF-8" enctype="multipart/form-data">
	<form:hidden path="vbHanhChinhId"/>
	<div id="bodyadmin">
	    <div id="header">
