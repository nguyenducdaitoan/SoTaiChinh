...
<title>Thêm mới thông tin giới thiệu</title>
...
<script type="text/javascript" charset="utf-8">
	$(document).ready(function() {
		$("img#imgSaveNews").click(function(){
			$("[name=GioiThieuAddForm]").submit();
		});
	});
</script>
</head>
<body>
	<form:form name="GioiThieuAddForm" method="POST" commandName="gioithieu" action="/admin/gioithieu/submitadd.html" accept-charset="UTF-8">
	<div id="bodyadmin">
	    <div id="header">
	        <div style="width: 250px; text-align:left; float:left; font-family: Tahoma; font-size:10pt;">
	            <img src="/admin/images/data.gif" title="" />&nbsp;Thêm mới thông tin giới thiệu
	        </div>
