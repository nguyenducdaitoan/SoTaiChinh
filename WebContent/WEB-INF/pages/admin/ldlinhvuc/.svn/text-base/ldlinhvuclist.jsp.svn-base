			...
			if (list_activities_id == "") {
				...
				if (ok) {
					$.ajax({
						cache: false,
						type: 'POST',
						url:   '/admin/ldlinhvuc/delete.html',
						...
						success: function(data) {
							...
							if ((getData.error != null) && (getData.error != '')) {
								...
								window.location.href = '/admin/ldlinhvuc/list.html?type=1'
							}
						},
    	...
    	<div id="header">
            ...
            <div style="width: 130px; text-align:right; float:right;">
            	<div style="position:absolute; top:1px;">
	                <a href="/admin/ldlinhvuc/add.html?type=1" title="News"><img id="btnadd" src="/admin/images/add.gif" style="border: none" title="New" /></a>&nbsp;
        	...
        	<table id="tableOne" class="tablesorter" cellspacing="1" style="width:100%; padding-top: 0px; margin-top: 0px">
                ...
                <tbody style="text-align:left;">
					...
					<tr>				
						...
						<td align="center">
							<c:out value="${ldlinhvuc.isMacDinh()}"/>															
						</td>
                        <td>
                        ...
                        <td>
                            ...
                            <span class="editItems"><a href="/admin/ldlinhvuc/edit.html?ldLinhVucId=<c:out value="${ldlinhvuc.getLdLinhVucId()}"/>"><img src="/admin/images/lightning_go.gif" title="Sửa" class="editIterm" style="border: none" /></a></span>
						</td>
                    </tr>
                </c:forEach>
