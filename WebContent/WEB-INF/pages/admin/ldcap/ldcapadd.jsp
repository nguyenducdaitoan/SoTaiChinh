...
<title>Thêm mới cấp cơ quan</title>
...
<body>
	<form:form commandName="ldcap" name="LdCapForm" id="formLdCapId" method="POST" action="/admin/ldcap/submitadd.html" accept-charset="UTF-8">
	<div id="bodyadmin">
	    <div id="header">
	        <div style="width: 250px; text-align:left; float:left; font-family: Tahoma; font-size:10pt;">
	            <img src="/admin/images/data.gif" title="" />&nbsp;Thêm mới cấp cơ quan
	        </div>
