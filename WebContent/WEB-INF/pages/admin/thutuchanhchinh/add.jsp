...
<title>Thêm mới thủ tục hành chính</title>
...
<body>
	<form:form name="ThuTucHanhChinhForm" commandName="thuTucHanhChinhForm" method="POST" action="/admin/thutuchanhchinh/add.html">
	<div id="bodyadmin">
	    <div id="header">
