...
<title>Chinh sua loại văn bản</title>
...
<body>
	<form:form commandName="ldloaivb" name="LdLinhVucForm" id="formldLinhVucId" method="POST" action="/admin/vbhanhchinhloaivb/submitedit.html" accept-charset="UTF-8">
	<form:hidden path="ldLoaiVbId"/>
	<input type="hidden" name="type" value="1">
	<div id="bodyadmin">
	    <div id="header">
	        <div style="width: 250px; text-align:left; float:left; font-family: Tahoma; font-size:10pt;">
	            <img src="/admin/images/data.gif" title="" />&nbsp;Chinh Sua Loại văn bản
	        </div>
