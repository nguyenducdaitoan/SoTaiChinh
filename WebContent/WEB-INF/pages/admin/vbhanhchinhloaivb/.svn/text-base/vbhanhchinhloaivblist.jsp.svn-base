			...
			if (list_activities_id == "") {
				...
				if (ok) {
					$.ajax({
						cache: false,
						type: 'POST',
						url:   '/admin/vbhanhchinhloaivb/delete.html',
						...
						success: function(data) {
							...
							if ((getData.error != null) && (getData.error != '')) {
								...
								window.location.href = '/admin/vbhanhchinhloaivb/list.html?type=2';
							}
						},
    	...
    	<div id="header">
            ...
            <div style="width: 130px; text-align:right; float:right;">
            	<div style="position:absolute; top:1px;">
	                <a href="/admin/vbhanhchinhloaivb/add.html?type=2" title="News"><img id="btnadd" src="/admin/images/add.gif" style="border: none" title="New" /></a>&nbsp;
                ...
                <c:forEach var="ldloaivb" items="${listldloaivb}" varStatus="status">
					<tr>				
                        ...
                        <td>
                            ...
                            <span class="editItems"><a href="/admin/vbhanhchinhloaivb/edit.html?ldLoaiVbId=<c:out value="${ldloaivb.getLdLoaiVbId()}"/>"><img src="/admin/images/lightning_go.gif" title="Sửa" class="editIterm" style="border: none" /></a></span>
						</td>
                    </tr>
 				</c:forEach>
				</tbody>
