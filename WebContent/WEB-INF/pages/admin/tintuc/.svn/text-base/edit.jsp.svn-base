	...
	$(document).ready(function() {
		$("img#imgSaveNews").click(function(){
			...
			if ($('textarea[name=summary]').val().trim() == '') {
				...
				$('select[name=summary]').select();
				return false;
			}
			
			if ($('#chuyenMucId').val().trim() == '-1') {
				alert('Chưa chọn chuyên mục');
				$('select#chuyenMucId').focus();
				return false;
			}
...
<body>
	<form:form name="TinTucForm" commandName="tinTucForm" method="POST" action="/admin/tintuc/edit.html">
	<form:hidden path="tinTucId"/>
	<div id="bodyadmin">
	    <div id="header">
	        <div style="width: 250px; text-align:left; float:left; font-family: Tahoma; font-size:10pt;">
	            <img src="images/data.gif" title="" />&nbsp;Chỉnh sửa tin tức
	        </div>
	    ...
	    <div id="content" style="font-family:Arial; font-size:10pt; text-align:left">
	    	<div style="clear:both; height:15px;"></div>
	            ...
	            <div style="float:left; width: 456px; text-align:left;">
	               <form:select path="chuyenMucId" name="chuyenMucId" id="chuyenMucId" style="background-color: #EDF8D6; border: 1px solid gray; font-family: Arial; width: 313px" class="SelectBox">
	        ...
	        <div>
	            ...
	            <div style="float:left; width: 456px; text-align:left;">
	            	<form:textarea path="summary" name="summary" style="width:100%"/>
	            </div>
	        </div>
	        <div style="clear:both; height: 3px;"></div>
	        <div>
	            ...
	            <div style="float:left; width: 456px; text-align:left;">
	            	<form:input path="pathImage" maxlength="90"
					 	id="fileNameId" style="width: 357px;" onclick="doBrowseServer('video', 'fileNameId');" cssClass="textbox"/> 
