...
<title>Thêm mới văn bản hướng dẫn</title>
...
<body>
	<form:form name="VbHuongdanAddForm" method="POST" commandName="vbhuongdan" action="/admin/vbhuongdan/submitadd.html" accept-charset="UTF-8">
	<form:errors path="*" cssClass="errorblock" element="div" />
	<div id="bodyadmin">
	    <div id="header">
	        <div style="width: 250px; text-align:left; float:left; font-family: Tahoma; font-size:10pt;">
	            <img src="/admin/images/data.gif" title="" />&nbsp;Thêm mới văn bản hướng dẫn
	        </div>
