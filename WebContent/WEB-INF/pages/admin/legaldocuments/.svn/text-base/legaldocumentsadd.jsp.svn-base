...
<body>
	<form:form commandName="legalDocument" name="LegalDocumentsForm" id="formLegalDocumentsId" method="POST" action="/admin/legaldocuments/submitadd.html" accept-charset="UTF-8" enctype="multipart/form-data">
	<div id="bodyadmin">
	    <div id="header">
