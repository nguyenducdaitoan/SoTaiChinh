...
<%@ page import="vn.softech.form.ThongbaoForm"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>Sửa thông tin thông báo</title>
...
<body>
	<form:form name="normal_form" commandName="thongbaoForm" method="POST"
		action="/admin/thongbao/edit.html">
		<form:hidden path="thongBaoId" />
		<div id="bodyadmin">
			<div id="header">
				<div
					style="width: 250px; text-align: left; float: left; font-family: Tahoma; font-size: 10pt;">
					<img src="images/data.gif" title="" />&nbsp;Sửa thông tin thông
					báo
				</div>
				<div
			...
			<div id="content"
				...
				<%
	        ThongbaoForm thongbaoForm = (ThongbaoForm) request.getAttribute("thongbaoForm");
			FCKeditor oFCKeditor;
			oFCKeditor = new FCKeditor(request,"txtFCKContent");
			oFCKeditor.setWidth("100%");
			oFCKeditor.setHeight("350");
			oFCKeditor.setBasePath("/fckeditor/");
			oFCKeditor.setValue(thongbaoForm.getContent());
