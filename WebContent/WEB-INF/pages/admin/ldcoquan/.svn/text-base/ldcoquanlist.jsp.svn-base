			...
			if (list_activities_id == "") {
				...
				if (ok) {
					$.ajax({
						cache: false,
						type: 'POST',
						url:   '/admin/ldcoquan/deleteajaxldcoquan.html',
						...
						success: function(data) {
							...
							if ((getData.error != null) && (getData.error != '')) {
								...
								window.location.href = '/admin/ldcoquan/list.html?type=1'
							}
						},
    	...
    	<div id="header">
            ...
            <div style="width: 130px; text-align:right; float:right;">
            	<div style="position:absolute; top:1px;">
	                <a href="/admin/ldcoquan/add.html?type=1" title="News"><img id="btnadd" src="/admin/images/add.gif" style="border: none" title="New" /></a>&nbsp;
                ...
                <c:forEach var="ldcoquan" items="${listldcoquan}" varStatus="status">
					<tr>				
                        ...
                        <td>
                            ...
                            <span class="editItems"><a href="/admin/ldcoquan/edit.html?ldCoQuanId=<c:out value="${ldcoquan.getLdCoQuanId()}"/>"><img src="/admin/images/lightning_go.gif" title="Sửa" class="editIterm" style="border: none" /></a></span>
						</td>
                    </tr>
 				</c:forEach>
				</tbody>
