...
<!--
		...
		[
			...
			["|<span style='text-shadow: 1px 1px #ffffff; cursor: pointer'>Chuyên mục</span>", "/admin/tintuc/danhmuclist.html", "shopping-cart2.gif","","","", "main"],
			["|<span style='text-shadow: 1px 1px #ffffff; cursor: pointer'>Thêm mới</span>", "/admin/tintuc/add.html", "shopping-cart2.gif","","","", "main"],
			...
			["|<span style='text-shadow: 1px 1px #ffffff; cursor: pointer'>Chuyên mục</span>", "/admin/thutuchanhchinh/danhmuclist.html", "shopping-cart2.gif","","","", "main"],
			["|<span style='text-shadow: 1px 1px #ffffff; cursor: pointer'>Thủ tục</span>", "/admin/thutuchanhchinh/list.html", "shopping-cart2.gif","","","", "main"],
			...
			["|<span style='text-shadow: 1px 1px #ffffff; cursor: pointer'>Sự kiện</span>", "/admin/sukien/list.html", "shopping-cart2.gif","","","", "main"],
			["|<span style='text-shadow: 1px 1px #ffffff; cursor: pointer'>Tin tức</span>", "/admin/sukientintuc/list.html", "shopping-cart2.gif","","","", "main"],
