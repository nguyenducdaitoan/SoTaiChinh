...
<title>Thêm mới tin tức sự kiện</title>
...
<body>
	<form:form name="SuKienTinTucForm" commandName="suKienTinTucForm" method="POST" action="/admin/sukientintuc/add.html">
	<div id="bodyadmin">
	    <div id="header">
	        <div style="width: 250px; text-align:left; float:left; font-family: Tahoma; font-size:10pt;">
	            <img src="images/data.gif" title="" />&nbsp;Thêm mới tin tức sự kiện
	        </div>
