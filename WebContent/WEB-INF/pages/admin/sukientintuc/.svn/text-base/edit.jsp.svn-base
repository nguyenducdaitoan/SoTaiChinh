...
<%@ page import="vn.softech.form.SuKienTinTucForm"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>Chỉnh sửa tin tức sự kiện</title>
...
<body>
	<form:form name="SuKienTinTucForm" commandName="suKienTinTucForm" method="POST" action="/admin/sukientintuc/edit.html">
	<form:hidden path="suKienTinTucId" />
	<div id="bodyadmin">
	    <div id="header">
	        <div style="width: 250px; text-align:left; float:left; font-family: Tahoma; font-size:10pt;">
	            <img src="images/data.gif" title="" />&nbsp;Chỉnh sửa tin tức sự kiện
	        </div>
	    ...
	    <div id="content" style="font-family:Arial; font-size:10pt; text-align:left">
	        ...
	        <div>
	            ...
	            <div style="float:left; width: 456px; text-align:left;">	                
	                <form:textarea path="summary" style="width:90%"/>
	            </div>
	        </div>
	        <div style="clear:both; height: 3px;"></div>
	        <div>
			...
			<%
			SuKienTinTucForm sukientintuc= (SuKienTinTucForm)request.getAttribute("suKienTinTucForm");
			FCKeditor oFCKeditor;
			oFCKeditor = new FCKeditor(request,"txtFCKContent");
			oFCKeditor.setWidth("100%");
			oFCKeditor.setHeight("350");
			oFCKeditor.setBasePath("/fckeditor/");
			String content= sukientintuc.getContent();
			if (content!=null) {
